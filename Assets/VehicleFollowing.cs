...
public class VehicleFollowing : MonoBehaviour {
	...
	public Path path; // Reference to path object it needs to follow

	// The speed and mass properties are needed to calculate its acceleration properly
	public float speed = 20.0f; 
	public float mass = 5.0f;
	public bool isLooping = true;

	// Actual speed of the vechicle
	...
	// We initialize the properties and set up the direction of our velocity vector with
	// the entitys forward vector in the Start method.
	void Start()
	{
	...
	// In our update method, we update the agent entitys position en rotation, 
	...
	void Update()
	{
		...
		//if reach the radius within the path them move to next
		// point in the path
