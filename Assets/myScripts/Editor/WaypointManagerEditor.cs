using UnityEngine;
using UnityEditor;
using UnityEditorInternal; // este es el namespace desde donde sale clase ReorderableList
using System.IO;
...
public class WaypointManagerEditor : Editor {
    ...
    /* Esta es la clase interesante ReorderableList para crear listas, la saco de UnityEditorInternal */
