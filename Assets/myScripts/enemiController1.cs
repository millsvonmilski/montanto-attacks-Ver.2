...
public class enemiController1 : MonoBehaviour {
		...
		public TestMueveNave mueveNAVE;
		...
		void Start() 
		{
			...
			{
				mueveNAVE = controladorMover.GetComponent<TestMueveNave>();
			}
		...
		{  		
			...
			} else if (sePAUSO == false) 
			{
				...
				mueveNAVE.StartCoroutine (mueveNAVE.Spawn ());  // COMIENZO A MOVER LA NAVE E INSTANCIO LOS ASTEROIDES
